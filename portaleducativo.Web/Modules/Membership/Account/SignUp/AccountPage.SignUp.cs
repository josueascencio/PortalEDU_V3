...
using portaleducativo.Administration;
using portaleducativo.Administration.Entities;
using portaleducativo.Administration.Repositories;
using portaleducativo.Common;
using Serenity;
using Serenity.Data;
...
namespace portaleducativo.Membership.Pages
{
